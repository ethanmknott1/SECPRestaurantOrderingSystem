...
public class GUI implements ActionListener {
    ...
    public GUI(){
        ...
        JButton b7 = new JButton("Meal 7");
        JButton b8 = new JButton("Meal 8");
        JButton b9 = new JButton("French Fries");
        JButton b10 = new JButton("Tater Tots");
        JButton b11 = new JButton("Water");
        JButton b12 = new JButton("Cola");
        JButton b13 = new JButton("Coffee");
        JButton b14 = new JButton("A la 6");
        JButton b15 = new JButton("A la 7");
        JButton b16 = new JButton("A la 8");
